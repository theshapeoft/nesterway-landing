export const landingContent = {
  ...
  capabilities: {
    title: "Everything You Need to Create Amazing Guest Experiences",
    highlights: [
      {
        title: "Simple to Get Started",
        description: "Choose a template, add your information, and generate your QR code. Most hosts are up and running in under 15 minutes.",
        icon: "rocket"
      },
      {
        title: "Easy to Share",
        description: "No apps to download. Works on any device. Update your guide anytime and changes appear instantly for all guests.",
        icon: "share"
      },
      {
        title: "Features You'll Love",
        description: "Offline access for remote properties. Beautiful mobile-optimized design. Guest analytics to see what matters most.",
        icon: "heart"
      }
    ]
  },
  ...
  pricing: {
    ...
    calculator: {
      ...
      description: "See exactly what you'll pay based on your property count"
    }
  },
