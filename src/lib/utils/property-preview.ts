...
/**
 * Fetch full property data for preview rendering on the client side.
 * This fetches all related data (wifi, contacts, sections) and transforms
 * it into the Property type used by guest-facing components.
 */
export async function fetchPropertyForPreview(
  ...
  const property: Property = {
    ...
    countryName:
      countryNames[dbProperty.country_slug || ""] || dbProperty.country_slug || "",
