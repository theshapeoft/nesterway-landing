...
- [x] Filename: `[property-slug]-guide-[YYYY-MM-DD].pdf`
- [x] Generation time: 3-5 seconds with progress indicator
- [x] Max file size: 10MB
- [x] Analytics event: `pdf_downloaded` (property_id, sections_included, branded)

**Technical Notes:**
- Client-side generation using `jsPDF` (already installed)
- Server action `getPropertyPdfData()` fetches all property data
- Custom PDF layout with cover page, TOC, and sections
- Automatic page breaks and section formatting
